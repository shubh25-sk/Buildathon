...
export type ProductCategory = 'TEXTILES' | 'AGRICULTURE' | 'ENGINEERING' | 'PHARMA' | 'CHEMICALS' | 'HANDICRAFTS' | 'ELECTRONICS' | 'OTHER';
...
export type CostCategory = 'PRODUCT' | 'INLAND' | 'ORIGIN_HANDLING' | 'DOCUMENTATION' | 'CUSTOMS' | 'FREIGHT' | 'INSURANCE' | 'DESTINATION_CHARGES' | 'LAST_MILE' | 'BANKING' | 'CONTINGENCY';
