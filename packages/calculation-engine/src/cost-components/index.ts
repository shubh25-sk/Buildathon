import { CalculationInput, CostCategory, CostComponent, Location } from '@export-cost/shared';
...
export function calculateAllComponents(ctx: ComponentCalcContext): CostComponent[] {
  ...
  if (input.packageType === 'PALLET') pkgCostPerUnit = 1200;
  if (input.packageType === 'CRATE') pkgCostPerUnit = 2500;
  if (input.packageType === 'CONTAINER_20FT') pkgCostPerUnit = 15000;
  if (input.packageType === 'CONTAINER_40FT') pkgCostPerUnit = 25000;
