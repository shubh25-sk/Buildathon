...
export function calculateExportCostIndicator(ctx: IndicatorCalculationContext): ExportCostIndicator {
  const {
    productValueInr,
    totalExportCostInr,
    logisticsCostInr,
  ...
  let level: 'EXCELLENT' | 'GOOD' | 'MODERATE' | 'CHALLENGING' = 'MODERATE';
